...
const Input: FC<Props> = ({
  ...
  return (
    <div className={cn("flex flex-col mb-3", className)}>
      {label && (
        <label htmlFor={name} className="text-sm mb-1 font-bold">
          {label}
        </label>
      )}
      <div className="relative">
        <input
          ...
          id={id}
          className={cn(
            "py-2 border border-gray-300 rounded px-3 w-full  outline-gray-300 ",
            {
        ...
        {type === "password" && (
          <img
            ...
            className="h-[20px] absolute right-5 top-3 cursor-pointer"
