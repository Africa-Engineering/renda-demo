      ...
      {files && files.length === 0 && (
        <div className={cn("flex flex-col my-2 ", className)}>
          ...
          <div className="relative">
            <div className="bg-white flex justify-center flex-col text-center cursor-pointer border-dotted border-2 border-[text-primary] outline-none px-8 py-4">
              <img src="/assets/images/upload.svg" className="h-[15px] mb-1" />
              <p className="text-sm text-gray-400">
                {" "}
                <span className="font-bold text-black">Click to upload </span>or drag to
                upload{" "}
              </p>
            </div>
            <input
